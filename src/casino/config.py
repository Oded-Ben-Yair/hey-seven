...
CASINO_PROFILES: dict[str, dict[str, Any]] = {
    ...
    "parx_casino": {
        ...
        "property_description": (
            ...
            "featuring an expansive gaming floor, diverse dining options, a live music venue "
            "(Xcite Center), and a sportsbook."
        ),
        "features": {
            "ai_disclosure_enabled": True,
            "whisper_planner_enabled": True,
        ...
        "operational": {
            ...
            "property_size_gaming_sqft": 260000,
            "dining_venues": 12,
            "hotel_towers": 0,
        },
        "prompts": {
            "system_prompt_override": None,
            "greeting_template": "Hi $guest_name, this is $persona_name from Parx Casino! How can I help you today?",
            "greeting_template_es": "Hola $guest_name, soy $persona_name de Parx Casino. Como puedo ayudarte hoy?",
            "fallback_message": "I want to make sure I get you the right answer. Let me connect you with someone who can help.",
            "casino_name_display": "Parx Casino",
        },
        "rag": {
            "min_relevance_score": 0.35,
            "top_k": 5,
    ...
    "wynn_las_vegas": {
        ...
        "property_description": (
            ...
            "an 18-hole golf course, a world-class spa, Forbes Five-Star dining, and a stunning "
            "Lake of Dreams entertainment feature."
        ),
        "features": {
            "ai_disclosure_enabled": True,
            "whisper_planner_enabled": True,
        ...
        "operational": {
            ...
            "session_timeout_hours": 48,
            "property_type": "commercial",
            "property_size_gaming_sqft": 189000,
            "dining_venues": 18,
            "hotel_towers": 2,
        },
        "prompts": {
            "system_prompt_override": None,
            "greeting_template": "Hi $guest_name, this is $persona_name from Wynn Las Vegas. How may I assist you today?",
            "greeting_template_es": "Hola $guest_name, soy $persona_name de Wynn Las Vegas. Como puedo ayudarte hoy?",
            "fallback_message": "I want to make sure I get you the right answer. Let me connect you with someone who can help.",
            "casino_name_display": "Wynn Las Vegas",
        },
        "rag": {
            "min_relevance_score": 0.35,
            "top_k": 5,
